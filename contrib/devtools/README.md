...
Provides utilities for managing copyright headers of `The INFINCOINCASH
...
INFINCOINCASH-Project/INFINCOINCASH repository.
...
Setup
---------
Configuring the github-merge tool for the INFINCOINCASH repository is done in the following way:

    git config githubmerge.repository INFINCOINCASH-Project/INFINCOINCASH
...
A script to optimize png files in the INFINCOINCASH
...
If there are 'unsupported' symbols, the return value will be 1 a list like this will be printed:
    ...
    .../64/test_infincoincash: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_infincoincash: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_infincoincash: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_infincoincash: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
