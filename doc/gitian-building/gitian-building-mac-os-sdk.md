...
The script [extract-osx-sdk.sh](https://github.com/infincoincash-project/infincoincash/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
infincoincash/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/infincoincash-project/infincoincash/blob/master/doc/README_osx.md) for troubleshooting tips.
