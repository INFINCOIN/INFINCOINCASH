Contributing to INFINCOIN CASH
============================

The INFINCOIN CASH project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/infincoincash-project/infincoincash/blob/master/doc/translation_process.md)
...
The following applies to code changes to the INFINCOIN CASH project, and is not to be
confused with overall INFINCOINCASH Network Protocol consensus changes.

Whether a pull request is merged into INFINCOIN CASH rests with the project merge
...
Patches that change INFINCOINCASH consensus rules are considerably more involved than
...
Where a patchset proposes to change the INFINCOINCASH consensus, it must have been
...
The project leader is the release manager for each INFINCOIN CASH release.
