...
"""Verify that starting infincoincash with -h works as expected."""
import subprocess

from test_framework.test_framework import infincoincashTestFramework
from test_framework.util import assert_equal

class HelpTest(infincoincashTestFramework):
    ...
    def run_test(self):
        self.log.info("Start infincoincash with -? for help text")
        ...
        self.log.info("Start infincoincash with -version for version information")
