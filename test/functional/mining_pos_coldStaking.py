...
from test_framework.infincoincash_node import infincoincashTestNode
...
class INFINCOINCASH_ColdStakingTest(infincoincashTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(infincoincashTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 ICC from the pot)
...
if __name__ == '__main__':
    INFINCOINCASH_ColdStakingTest().main()
