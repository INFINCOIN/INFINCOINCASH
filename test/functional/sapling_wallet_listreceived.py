...
class ListReceivedTest (infincoincashTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 ICC.
        ...
        # Send 1 ICC to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 ICC sending them all (fee is 0.1 ICC)
        ...
        # Confirm transaction (2 ICC from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 ICC, send 0.6 ICC + 0.05 ICC fee
