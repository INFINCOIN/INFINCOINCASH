...
#ifndef INFINCOINCASH_STAKEINPUT_H
#define INFINCOINCASH_STAKEINPUT_H
...
class CIccStake : public CStakeInput
{
private:
...
public:
    CIccStake(const CTxOut& _from, const COutPoint& _outPointFrom, const CBlockIndex* _pindexFrom) :
            CStakeInput(_pindexFrom), outputFrom(_from), outpointFrom(_outPointFrom) {}

    static CIccStake* NewIccStake(const CTxIn& txin);
...
#endif //INFINCOINCASH_STAKEINPUT_H
