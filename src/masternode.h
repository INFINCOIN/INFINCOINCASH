...
static const CAmount MN_COLL_AMT = 1000000000 * COIN;
...
//
// The Masternode Class. It contains the input of the 10000 ICC, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 10000 ICC - checking if valid masternode)
