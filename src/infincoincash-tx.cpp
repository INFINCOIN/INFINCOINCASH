...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = _("infincoin cash infincoincash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  infincoincash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded infincoincash transaction") + "\n" +
                               "  infincoincash-tx [options] -create [commands]   " + _("Create hex-encoded infincoincash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded infincoincash transaction
