...
#ifndef INFINCOINCASH_QT_WALLETMODEL_H
#define INFINCOINCASH_QT_WALLETMODEL_H
...
/** Interface to INFINCOINCASH wallet from Qt view code. */
...
#endif // INFINCOINCASH_QT_WALLETMODEL_H
