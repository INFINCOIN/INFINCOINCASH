...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            INFINCOINCASHGUI* window = static_cast<INFINCOINCASHGUI*>(parentWidget());
...
{
    INFINCOINCASHGUI* gui = static_cast<INFINCOINCASHGUI*>(parentWidget());
...
{
    hide();
    static_cast<INFINCOINCASHGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("INFINCOIN CASH will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your ICCs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
