...
/** Utility functions used by the INFINCOINCASH Qt UI.
 */
namespace GUIUtil
{
...
// Render INFINCOINCASH addresses in monospace font
...
// Parse "infincoincash:" URI into recipient object, return true on successful parsing
