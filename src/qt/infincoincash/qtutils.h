...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, INFINCOINCASHGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, INFINCOINCASHGUI* gui, double posX = 3);
