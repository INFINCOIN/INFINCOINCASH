...
#include <QWidget>
#include <QString>
#include "qt/infincoincash/prunnable.h"
...
class PWidget : public QWidget, public Runnable, public Translator
{
    Q_OBJECT
public:
    explicit PWidget(INFINCOINCASHGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    INFINCOINCASHGUI* getWindow() { return this->window; }
