...
#include "qt/infincoincash/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/infincoincash/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(INFINCOINCASHGUI* _window, QWidget *parent) :
