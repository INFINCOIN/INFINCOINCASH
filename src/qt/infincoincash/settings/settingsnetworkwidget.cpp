...
#include "qt/infincoincash/settings/settingsnetworkwidget.h"
#include "qt/infincoincash/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/infincoincash/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(INFINCOINCASHGUI* _window, QWidget *parent) :
