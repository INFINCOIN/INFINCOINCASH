...
#include "qt/infincoincash/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/infincoincash/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(INFINCOINCASHGUI* _window, QWidget* parent) : PWidget(_window, parent),
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(CMD_REPLY, (tr("Welcome to the INFINCOIN CASH RPC console.") + "<br>" + tr("Use up and down arrows to navigate history, and %1 to clear screen.").arg("<b>" + clsKey + "</b>") + "<br>" + tr("Type <b>help</b> for an overview of available commands.") + "<br><span class=\"secwarning\"><br>" + tr("WARNING: Scammers have been active, telling users to type commands here, stealing their wallet contents. Do not use this console without fully understanding the ramifications of a command.") + "</span>"),
        true);
}
...
static bool PotentiallyDangerousCommand(const QString& cmd)
{
    ...
    if (cmd.size() >= 13 && cmd.leftRef(11) == "dumpprivkey") {
        // valid INFINCOINCASH Transparent Address
        std::vector<std::string> args;
    ...
    if (cmd.size() >= 18 && cmd.leftRef(16) == "exportsaplingkey") {
        // valid INFINCOINCASH Shield Address
        std::vector<std::string> args;
        parseCommandLineSettings(args, cmd.toStdString());
