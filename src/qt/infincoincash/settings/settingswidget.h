...
#include <QWidget>
#include "qt/infincoincash/pwidget.h"
#include "qt/infincoincash/settings/settingsbackupwallet.h"
#include "qt/infincoincash/settings/settingsexportcsv.h"
#include "qt/infincoincash/settings/settingsbittoolwidget.h"
#include "qt/infincoincash/settings/settingssignmessagewidgets.h"
#include "qt/infincoincash/settings/settingswalletrepairwidget.h"
#include "qt/infincoincash/settings/settingswalletoptionswidget.h"
#include "qt/infincoincash/settings/settingsmainoptionswidget.h"
#include "qt/infincoincash/settings/settingsdisplayoptionswidget.h"
#include "qt/infincoincash/settings/settingsmultisendwidget.h"
#include "qt/infincoincash/settings/settingsinformationwidget.h"
#include "qt/infincoincash/settings/settingsconsolewidget.h"

class INFINCOINCASHGUI;
...
public:
    explicit SettingsWidget(INFINCOINCASHGUI* parent);
    ~SettingsWidget();
