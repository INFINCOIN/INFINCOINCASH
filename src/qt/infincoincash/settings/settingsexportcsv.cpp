...
#include "qt/infincoincash/settings/forms/ui_settingsexportcsv.h"
#include <QFile>

SettingsExportCSV::SettingsExportCSV(INFINCOINCASHGUI* _window, QWidget* parent) : PWidget(_window, parent),
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
        ...
        isTxExport ? tr("INFINCOINCASH_tx_csv_export(*.csv)") : tr("INFINCOINCASH_addresses_csv_export(*.csv)"),
        nullptr);
