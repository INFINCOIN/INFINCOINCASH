...
#include "qt/infincoincash/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/infincoincash/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(INFINCOINCASHGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to INFINCOINCASHGUI::handleRestart()
