...
#include "qt/infincoincash/topbar.h"
#include "qt/infincoincash/forms/ui_topbar.h"
#include "qt/infincoincash/lockunlock.h"
#include "qt/infincoincash/qtutils.h"
#include "qt/infincoincash/receivedialog.h"
#include "qt/infincoincash/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/infincoincash/balancebubble.h"
...
TopBar::TopBar(INFINCOINCASHGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopIcc, ui->labelAmountTopShieldedIcc}, "amount-small-topbar");
    setCssProperty({ui->labelAmountIcc}, "amount-topbar");
    setCssProperty({ui->labelPendingIcc, ui->labelImmatureIcc}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("INFINCOINCASH")
    updateDisplayUnit();
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // ICC Total
    QString totalIcc = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // ICC
    // Top
    ui->labelAmountTopIcc->setText(totalTransparent);
    ui->labelAmountTopShieldedIcc->setText(totalShielded);
    // Expanded
    ui->labelAmountIcc->setText(totalIcc);
    ui->labelPendingIcc->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmatureIcc->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
