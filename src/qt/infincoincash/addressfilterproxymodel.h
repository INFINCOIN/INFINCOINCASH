...
#ifndef INFINCOINCASH_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define INFINCOINCASH_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //INFINCOINCASH_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
