...
#include "qt/infincoincash/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(INFINCOINCASHGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &INFINCOINCASHGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
