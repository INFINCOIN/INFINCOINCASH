...
/* infincoincash GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "INFINCOINCASH"
#define QAPP_ORG_DOMAIN "infincoincash.org"
#define QAPP_APP_NAME_DEFAULT "INFINCOINCASH-Qt"
#define QAPP_APP_NAME_TESTNET "INFINCOINCASH-Qt-testnet"
