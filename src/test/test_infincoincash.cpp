...
#define BOOST_TEST_MODULE infincoincash Test Suite
...
{
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_infincoincash_%lu_%i", (unsigned long)GetTime(), (int)(InsecureRandRange(100000)));
