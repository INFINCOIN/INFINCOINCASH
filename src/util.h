...
extern const char * const INFINCOINCASH_CONF_FILENAME;
extern const char * const INFINCOINCASH_PID_FILENAME;
extern const char * const INFINCOINCASH_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("infincoincash-%s", name);
