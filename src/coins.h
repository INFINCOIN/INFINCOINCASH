...
public:
    ...
    /**
     * Amount of infincoincash coming in to a transaction
...
// INFINCOINCASH: When check is false, this assumes that overwrites are never possible due to BIP34 always in effect
